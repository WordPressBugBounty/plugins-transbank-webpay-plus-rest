...
namespace TransbankVendor\GuzzleHttp;

use TransbankVendor\GuzzleHttp\Cookie\CookieJar;
use TransbankVendor\GuzzleHttp\Exception\GuzzleException;
use TransbankVendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \TransbankVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
