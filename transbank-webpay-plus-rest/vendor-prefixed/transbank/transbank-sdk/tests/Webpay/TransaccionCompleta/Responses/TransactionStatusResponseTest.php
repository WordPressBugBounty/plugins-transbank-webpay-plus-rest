...
class TransactionStatusResponseTest extends TestCase
{
    ...
    {
        $this->json = ['vci' => 'Some VCI', 'prepaid_balance' => 100];
        $this->response = $this->getMockBuilder(TransactionStatusResponse::class)->setConstructorArgs([$this->json])->onlyMethods(['setTransactionStatusFields'])->getMock();
    }
    #[Test]
...
\class_alias('TransbankVendor\TransactionStatusResponseTest', 'TransactionStatusResponseTest', \false);
