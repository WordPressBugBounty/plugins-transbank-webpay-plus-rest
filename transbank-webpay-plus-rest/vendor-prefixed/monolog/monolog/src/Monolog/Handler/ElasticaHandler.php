...
use TransbankVendor\Elastic\Transport\Exception\TransportException;
use TransbankVendor\Elastica\Document;
use TransbankVendor\Monolog\Formatter\FormatterInterface;
use TransbankVendor\Monolog\Formatter\ElasticaFormatter;
use TransbankVendor\Monolog\Level;
use TransbankVendor\Elastica\Client;
use TransbankVendor\Elastica\Exception\ExceptionInterface;
