...
use Closure;
use TransbankVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use TransbankVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use TransbankVendor\Monolog\Level;
use TransbankVendor\Monolog\Logger;
use TransbankVendor\Monolog\ResettableInterface;
use TransbankVendor\Monolog\Formatter\FormatterInterface;
use TransbankVendor\Psr\Log\LogLevel;
