 ...
 */
namespace TransbankVendor\Monolog\Handler;

use TransbankVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use TransbankVendor\Monolog\Level;
use TransbankVendor\Monolog\Formatter\FormatterInterface;
use TransbankVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use TransbankVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use TransbankVendor\Elasticsearch\Client;
use TransbankVendor\Monolog\LogRecord;
use TransbankVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use TransbankVendor\Elastic\Elasticsearch\Client as Client8;
/**
