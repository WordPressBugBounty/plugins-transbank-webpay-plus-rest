...
use TransbankVendor\Monolog\Utils;
use TransbankVendor\PhpConsole\Connector;
use TransbankVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use TransbankVendor\PhpConsole\Helper;
use TransbankVendor\Monolog\LogRecord;
use TransbankVendor\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('TransbankVendor\PhpConsole\Connector')) {
